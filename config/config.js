module.exports = {
     ...
     * @optional
     */
    description: "TODO nsslabs integration description",
    entityTypes: ['ipv4'],
    /**
    ...
    block: {
        component: {
            file: "./components/nsslabs-block.js"
        },
        template: {
            file: "./templates/nsslabs-block.hbs"
        }
    },
    summary: {
        component: {
            file: './components/nsslabs-summary.js'
        },
        template: {
            file: './templates/nsslabs-summary.hbs'
        }
    },
    request: {
